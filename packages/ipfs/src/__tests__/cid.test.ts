...
describe('getCid — known values (mirrors pulse-protocol-go/ipfs/cid_test.go)', () => {
  ...
  it('known block from send_test_consent.js (V1 mid-tier test)', async () => {
    const block = new Uint8Array([
      163, 100, 107, 101, 121, 49, 106, 75, 69, 89, 49, 114, 97, 110, 100, 111,
      109, 100, 107, 101, 121, 50, 106, 75, 69, 89, 50, 114, 97, 110, 100, 111,
      109, 103, 99, 111, 110, 115, 101, 110, 116, 120, 42, 67, 79, 78, 83, 69,
      78, 84, 95, 82, 69, 86, 84, 69, 83, 84, 49, 49, 55, 54, 57, 48, 49, 49,
      51, 49, 53, 52, 53, 56, 49, 55, 54, 57, 48, 49, 49, 51, 49, 53, 52, 53, 56,
    ])
