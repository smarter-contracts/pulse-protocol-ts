...
import { signConsent, signRevoke, getConsentAddress, getRevokeAddress, packMessage, buildMessage, ethereumTextHash, parseContractAddress } from '../signing.js'
...
describe('EIP-191 Signing — known values (mirrors pulse-protocol-go/crypto/signing_test.go)', () => {
  ...
  describe('SignRevoke — known values', () => {
    it('revoke with two CIDs', () => {
      ...
      const expectedPacked = ''
      const expectedPackedHash = '26f90118453374476e6d1c9462e6dbc16e17fa88974ef780c385a3e66847757d'
      const expectedSigningHash = '01eae01192709113c2bebbf955e237757a8d2a9e6e30f147bcf61f44abced572'
      const expectedSignature = 'eb2ccdade157f21e4a790f0acaa1aa1f74222754e88004bbc94f8829a7b039cb04270295d7cf72a52d2003830e09cac7a14f03b301834937e92ff8f600c0171d1b'
