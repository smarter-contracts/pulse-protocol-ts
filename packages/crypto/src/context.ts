 ...
 */
export function contextString(chainId: number, contractAddress: string, consentNumber: number): string {
 ...
 */
export function contextHash(chainId: number, contractAddress: string, consentNumber: number): Uint8Array {
